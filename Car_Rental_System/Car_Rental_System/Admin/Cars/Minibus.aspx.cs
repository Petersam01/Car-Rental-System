...
namespace Car_Rental_System.Admin.Cars
{
    ...
    public partial class Minibus : System.Web.UI.Page
    {
        ...
        protected void register_Click(object sender, EventArgs e)
        {
            ...
            MiniB newMini = new MiniB(name.Value,"Minibus", textarea.Value, distance.Value, carImage, adminID);

            db.InsertMiniBus(newMini);
            Response.Redirect("/Admin/Cars/Minibus.aspx");
