...
namespace Car_Rental_System.Admin.Cars
{
    ...
    public partial class Sedan : System.Web.UI.Page
    {
        ...
        protected void register_Click(object sender, EventArgs e)
        {
            ...
            CarSedan newSedan = new CarSedan(name.Value,"Sedan", textarea.Value, distance.Value, carImage, adminID);

            db.InsertSedan(newSedan);
            Response.Redirect("/Admin/Cars/Sedan.aspx");
